...
const apiKey = "cce327de7f701ed939b9c7c311bc8656";
...
function displayWeatherInfo(data) {
    ...
    tempDisplay.textContent = `${temperatureCelsius.toFixed(2)}°C`; // Display in Celsius by default
    ...
    toggleButton.addEventListener("click", function() {
        if (toggleButton.textContent === "°C") {
            tempDisplay.textContent = `${temp.toFixed(2)}°K`;
            toggleButton.textContent = "°K";
        } else {
